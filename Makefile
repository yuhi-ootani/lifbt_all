...
#    Updated: 2025/04/03 13:35:25 by oyuhi            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_array_count_str.c ft_bzero.c ft_calloc.c ft_isspace.c ft_isnumber.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
		...
		ft_putchar_fd.c ft_putendl_fd.c ft_putendl.c ft_putnbr_fd.c ft_putstr_fd.c ft_realloc.c ft_split.c ft_split_not_inquote.c ft_strchr.c \
